          ...
          child: ListView.builder(itemCount: data.length,itemBuilder: ((context, index) {
            return Column(
                            ...
                            children: [
                              ...
                              if(data[index].spons.length>0)Text(data[index].category,
                              ...
                              data[index].category!="Title"?GridView.count(
                              ...
                              ):CarouselSlider.builder(itemCount: data[index].spons.length, itemBuilder: ((context, i, realIndex) {
                            return SponsorCard(sponsor: data[index].spons[i],);
